...
Cao, Carroll, and Michalakis~\cite{cao2017} construct an emergent geometry from mutual information.  Their construction uses $k = N$: all subsystems participate.  The resulting geometry is objective---all observers agree.
