...
\subsection{Connection to Cao-Carroll-Chatwin-Davies}

Cao, Carroll, and Chatwin-Davies~\cite{cao2017} construct emergent geometry from mutual information, as we do. Their construction produces a \emph{single} geometry from a boundary state. Our construction produces a \emph{family} of geometries, one per observer.
...
\bibitem{forman2003}
R.~Forman, Adv.\ Math.\ \textbf{134}, 90 (2003).
